...
class PrivateGuildMemberResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatar", "avatar_decoration_data", "banner", "communication_disabled_until", "flags", "joined_at", "nick", "pending", "premium_since", "roles", "collectibles", "user", "mute", "deaf", "permissions"]
