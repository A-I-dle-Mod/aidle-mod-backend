...
class MinimalContentMessageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "content", "mentions", "mention_roles", "attachments", "embeds", "timestamp", "edited_timestamp", "flags", "components", "stickers", "sticker_items"]
