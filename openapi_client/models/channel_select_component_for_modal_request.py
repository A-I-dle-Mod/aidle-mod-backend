...
class ChannelSelectComponentForModalRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "custom_id", "placeholder", "min_values", "max_values", "disabled", "required", "default_values", "channel_types"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelSelectComponentForModalRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelSelectComponentForModalRequest from a dict"""
        if obj is None:
            return None
