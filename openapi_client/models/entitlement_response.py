...
class EntitlementResponse(BaseModel):
    ...
    gifter_user_id: Optional[Annotated[str, Field(strict=True)]] = None
    __properties: ClassVar[List[str]] = ["id", "sku_id", "application_id", "user_id", "guild_id", "deleted", "starts_at", "ends_at", "type", "fulfilled_at", "fulfillment_status", "consumed", "gifter_user_id"]
    ...
    @field_validator('gifter_user_id')
    def gifter_user_id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gifter_user_id": obj.get("gifter_user_id")
        })
        return _obj
